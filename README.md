# 🧴 Moisturisers — Seasonality & Intra-Category Migration Dashboard
...
[![CI](https://github.com/YOUR-USERNAME/moisturisers-dashboard/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR-USERNAME/moisturisers-dashboard/actions)
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://share.streamlit.io/YOUR-USERNAME/moisturisers-dashboard/app.py)
...
```bash
git clone https://github.com/YOUR-USERNAME/moisturisers-dashboard.git
cd moisturisers-dashboard
...
3. Your link goes live at `https://YOUR-USERNAME.github.io/moisturisers-dashboard/`.
...
```bash
# 1. create an EMPTY repo named e.g. moisturisers-dashboard on github.com (do NOT add a README there)
# 2. then, from this folder:
git init
git add .
git commit -m "Moisturisers interactive dashboard (Streamlit + formula-driven Excel)"
git branch -M main
git remote add origin https://github.com/YOUR-USERNAME/moisturisers-dashboard.git
...
data/sample_journeys.csv   Bundled sample (655 customers)
