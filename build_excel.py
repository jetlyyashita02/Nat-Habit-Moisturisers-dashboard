"""
Builds 'Moisturisers_Formula_Driven_Dashboard.xlsx' — a fully formula-driven
...
OUT = "Moisturisers_Formula_Driven_Dashboard.xlsx"
...
readme = [
    ...
    ("S", "Seasonality & Intra-Category Migration · Jan 2024 – Jun 2026 · works entirely with native Excel formulas (no macros)"),
    ("B", ""),
...
dash["B2"] = "🧴 MOISTURISERS INTERACTIVE DASHBOARD"; dash["B2"].font = TITLE
