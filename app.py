...
st.set_page_config(page_title="Moisturisers Interactive Dashboard",
...
with st.sidebar:
    ...
    st.caption("Seasonality & Intra-Category Migration — interactive explorer")
...
# ---------------------------------------------------------------- header
st.title("🧴 Moisturisers Interactive Dashboard")
